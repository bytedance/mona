...
| key             | 类型                                                                                                                                                                                       | 含义                                                                                                                                                                                                          | 示例 |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
| showFrom<br />  | 0 \| 1 \| 2 \| 3 \| 4<br />                                                                                                                                                                | 0：点击 tab 进入<br />自定义按钮跳转<br />1：店铺单进入 order_id<br />2：商品单进入 sku_order_id<br />3：售后单进入 after_sale_id<br />4：商品列表进入 product_id<br />![](./image-1-1636359158987.png)<br /> |      |
...
| extraData<br /> | Record<string,string><br />                                                                                                                                                                | 自定义按钮中配置的参数<br />路径【飞鸽】-【客服管理】-【应用设置】<br />![](./image-2-1636359160019.png)<br />                                                                                                |      |
