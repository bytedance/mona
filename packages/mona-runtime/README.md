...
| 名称    | 类型                                                 | 是否必填 | 描述                                                                                                                                                                                                                                                                                                                          |
| ------- | ---------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| success | Function                                             | ❌       | 1. 用户未被拉黑 <br /><br /> &nbsp;&nbsp;- 正在接待中 ，✅ 可复制 <br /><br /> &nbsp;&nbsp;- 用户不在接待中，下列条件同时满足， ✅ 可复制 <br /><br /> &nbsp;&nbsp;&nbsp;&nbsp;_ 客服非离线 <br /><br /> &nbsp;&nbsp;&nbsp;&nbsp;_ 7 天内有会话 <br /><br /> &nbsp;&nbsp;&nbsp;&nbsp;\* 当前用户没有正在与其他客服对话 <br /> |
...
| 名称    | 类型                                                 | 是否必填 | 描述             |
| ------- | ---------------------------------------------------- | -------- | ---------------- |
| success | (token: string) => void                              | ❌       | 获取登录态 token |
...
![](https://p3-ecom-fe.byteimg.com/tos-cn-i-w59vco1lho/04922a15758344339194b16dad5ea2e2.png~tplv-w59vco1lho-png.png)
![](https://p3-ecom-fe.byteimg.com/tos-cn-i-w59vco1lho/9c5dd44059381606a3d2cd90b359c83b.png~tplv-w59vco1lho-png.png)
...
| query<br />     | interface InitInfo {<br />order_id?: string;<br />sku_order_id?: product_id;<br />after_sale_id?: string;<br />product_id?: string;<br />} | 官方参数。申请权限后，自定义按钮跳转会携带位置对应参数。<br />                                                                                                                                                                                                                                                                                                 |
| extraData<br /> | Record<string,string><br />                                                                                                                | 自定义按钮中配置的参数<br />路径【飞鸽】-【客服管理】-【应用管理】- 【应用设置】-【非官方插件-设置】<br />![](https://p3-ecom-fe.byteimg.com/tos-cn-i-w59vco1lho/b77b699287e5692cd940b000c60b6965.png~tplv-w59vco1lho-png.png)<br />![](https://p3-ecom-fe.byteimg.com/tos-cn-i-w59vco1lho/0e075d12e48790fde76a6dd6d8b87245.png~tplv-w59vco1lho-png.png)<br /> |
