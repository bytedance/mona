...
| query<br />     | interface InitInfo {<br />order_id: string;<br />sku_order_id: product_id;<br />after_sale_id: string;<br />product_id: string;<br />} | 官方参数。申请权限后，自定义按钮跳转会携带位置对应参数。<br />- 位置 3 : after_sale_id <br /><br />- 位置 5 : order_id <br /><br />- 位置 4 : sku_order_id <br /><br />- 位置 1 : product_id <br /><br />![](https://p3-ecom-fe.byteimg.com/tos-cn-i-w59vco1lho/ab2863d8dd23b0c5872fea83b02dbd9c.png~tplv-w59vco1lho-png.png)<br /> |
