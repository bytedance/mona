...
export const bubbleEventsAlias = {
  ...
  catchTransitionEnd: 'catchtransitionend',
  catchAnimationStart: 'catchanimationstart',
  catchAnimationIteration: 'catchanimationiteration',
  catchAnimationEnd: 'catchanimationend',
  catchTouchForceChange: 'catchtouchforcechange',
};
